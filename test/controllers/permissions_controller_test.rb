...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post permissions_url, params: { permission: { given_by: @permission.given_by, granted_to: @permission.granted_to, permissions: @permission.permissions } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { given_by: @permission.given_by, granted_to: @permission.granted_to, permissions: @permission.permissions } }
